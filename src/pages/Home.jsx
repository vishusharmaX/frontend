            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text_para">
                  In this world, wherever there is light, there are always
                  shadows. As long as there is a concept of victors, the
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="test__para">
                  ...
                  online scheduling too to select an appointment time.
                </li>
              </ul>
              <Link to="/">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className="w-5 h-4 lg:w-[34px] lg:h-[34px] flex items-center justify-center
                        bg-yellowColor rounded py-1 px-[6x] lg:px-[9px]"
                  >
